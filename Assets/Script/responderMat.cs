...
public class responderMat : MonoBehaviour {
    public int idTema;
    ...
    void proximaPergunta()
    {
        ...
        else
        {
            ...
            if (notaFinal > PlayerPrefs.GetInt("notaFinalMat" + idTema.ToString()))
            {
                PlayerPrefs.SetInt("notaFinalMat" + idTema.ToString(), notaFinal);
                PlayerPrefs.SetInt("acertos" + idTema.ToString(), (int)acertos);

            }

            PlayerPrefs.SetInt("notaFinalMatTemp" + idTema.ToString(), notaFinal);
            PlayerPrefs.SetInt("acertosTemp" + idTema.ToString(), (int)acertos);

            Application.LoadLevel("NotaFinalMat");
        }
    }
}
